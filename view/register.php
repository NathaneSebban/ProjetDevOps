...
<head>
    ...
    <title>Flixdeo - Inscription</title>
...
<body>
    ...
    <main class="mt-5">
        <div class="container mx-auto col-4 rounded p-5 d-flex flex-column justify-content-center"
            ...
            <h2 class="text-center mb-5" style="color: rgb(220, 220, 220);">S'inscrire</h2>
    ...
    backdrop-filter: blur(7px) !important;" class="form-control" placeholder="Mot de passe" name="password"
                ...
                <div class="input-group">
                    <a href="../Se-connecter" class="mt-4">Oups, vous aviez déjà un compte ?</a>
                </div>

                <button type="submit" name="inscription" value="valider" class="btn btn-danger mt-5">Valider</button>
